...
A 2D space shooter built with [LÖVE](https://love2d.org/) (Lua). Fight waves of enemies, battle bosses, collect components, and build your ultimate ship in the hangar.

---

## Features

- **Wave-based combat** — Enemies get tougher every wave. Boss every 10 waves.
...
- **Persistent upgrades** — Currency and upgrades persist between runs.
- **Touch controls** — Virtual joystick, fire button, and item buttons. Left/right handed mode.
- **Visual effects** — Procedural parallax background, solar systems, post-processing shader, particle explosions.
...
├── conf.lua              # Window configuration (700x400, landscape)
├── LICENSE
├── README.md
├── .gitignore
